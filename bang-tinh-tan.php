...
<html lang="vi">
<head>
	<title>Bảng tuần hoàn các nguyên tố hóa học &middot; junlxrd</title>
	...
	<section id="content">
		...
		<div class="container" id="mainContents">
			<div class="page-header">
				<h1>
					Bảng tính tan của chất hoá học 
				</h1>
			</div>
			<div class="row">
				<center><img src='https://i.imgur.com/EWOGexu.jpg' border='0'/></center>
			</div>
			<hr />
