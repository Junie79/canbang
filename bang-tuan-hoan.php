...
<title>3D - Bảng Tuần Hoàn Hóa Học &middot; junlxrd</title>
<style>
html, body {
	height: 100%;
}
...
<div id="info"><a href="https://facebook.com/junieeeahhh" alt="logo"><b style="font-size: 30px; font-family: 'Source Code Pro', monospace;"><u>junlxrd</u></b></a> &middot; <a href="./index.php" alt="Bảng tuần hoàn">Cân bằng hóa học</a> &middot; <a href="./bang-tuan-hoan-2d.php" alt="Bảng tuần hoàn">Bảng tuần hoàn</a> &middot; <a href="./bang-tuan-hoan.php" alt="Bảng tuần hoàn (3D)">Bảng tuần hoàn (3D)</a> &middot; <a href="./hoa-tri.php" alt="Bảng hóa trị">Bảng hóa trị</a> &middot;  <a href="./bang-tinh-tan.php" alt="Bảng tính tan">Bảng tính tan</a></div>
<div id="menu">
